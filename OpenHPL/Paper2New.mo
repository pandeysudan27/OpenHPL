...
extends Modelica.Icons.ExamplesPackage;
  ...
  model TLRSimple "Model of Trollheim HPP with sharp orifice surge tank."
    ...
    Modelica.Blocks.Sources.Ramp control(duration = 0,
      height=-0.25,
      offset=0.01,
      startTime=200)                                                                                 annotation (
      Placement(visible = true, transformation(origin = {-10, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenHPL.Waterway.Pipe intake(H = 20, L = 4500, D_i = 6, D_o = 6,
      SteadyState=true)                                              annotation (
    ...
    OpenHPL.Waterway.SurgeTankTest surgetank(D = 4, D_so = 2, D_t = 2, H = 80, L = 80, L_t = 20, SurgeTankType = OpenHPL.Types.SurgeTank.STSimple,
      SteadyState=true,                                                                                                                            h_0 = 50) annotation (
  ...
  model TLRSharp "Model of Trollheim HPP with sharp orifice surge tank."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r = 50) annotation (
      Placement(visible = true, transformation(origin = {-90, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Ramp control(duration = 0,
    ...
    ElectroMech.Turbines.Turbine turbine(ValveCapacity = false, C_v = 3.7, H_n = 370, Vdot_n = 40, ConstEfficiency = false) annotation (
      Placement(visible = true, transformation(origin = {30, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenHPL.Waterway.SurgeTankTest surgetank(D = 4,
      D_so=1,                                                 D_t = 2, H = 80, L = 80, L_t = 20, SurgeTankType = OpenHPL.Types.SurgeTank.STSharpOrifice,
      SteadyState=true,                                                                                                                                  h_0 = 50) annotation (
      Placement(visible = true, transformation(origin = {-30, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(surgetank.o, penstock.i) annotation (
  ...
  model TLRThroat "Model of Trollheim HPP with sharp orifice surge tank."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r = 50) annotation (
      Placement(visible = true, transformation(origin = {-90, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Ramp control(duration = 0,
