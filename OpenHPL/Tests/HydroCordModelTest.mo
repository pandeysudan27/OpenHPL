...
model HydroCordModelTest "Model of Trollheim hydro power plant."
  ...
  OpenHPL.Waterway.Pipe discharge1(
    ...
    H=17.5 - 14,
    L=601,
    p_eps=0.05) annotation (Placement(visible=true, transformation(extent={{42, -14}, {62, 6}},                                                                          rotation=0)));
  ...
  OpenHPL.Waterway.Fitting fitting annotation(
    Placement(visible = true, transformation(origin = {0, 24}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  connect(turbine.o, discharge1.i) annotation(
    Line(points = {{22, -20}, {42, -20}, {42, -4}}, color = {28, 108, 200}));
  connect(turbine.i, penstock2.o) annotation(
    Line(points = {{2, -20}, {-7, -20}, {-7, -12}, {-26, -12}}, color = {28, 108, 200}));
  connect(per_gain.y, turbine.u_t) annotation(
    Line(points = {{-11, -44}, {40, -44}, {40, 20}, {12, 20}, {12, -8}}, color = {0, 0, 127}));
  connect(fitting.o, penstock2.i) annotation(
    Line(points = {{0, 14}, {-26, 14}, {-26, 8}}, color = {28, 108, 200}));
  connect(fitting.i, penstock1.o) annotation(
    Line(points = {{0, 34}, {10, 34}, {10, 44}, {10, 44}}, color = {28, 108, 200}));
  connect(discharge2.i, discharge1.o) annotation(
    Line(points = {{64, 18}, {64, -4}, {62, -4}}, color = {28, 108, 200}));
  ...
  connect(intake3.i, intake2.o) annotation(
    Line(points = {{-36, 60}, {-38, 60}, {-38, 62}}, color = {28, 108, 200}));
  connect(intake3.o, surgeTank.i) annotation(
    Line(points = {{-16, 60}, {-18, 60}, {-18, 70}}, color = {28, 108, 200}));
  ...
  connect(tail.o, discharge2.o) annotation(
    Line(points = {{88, 8}, {88, 10}, {84, 10}, {84, 18}}, color = {28, 108, 200}));
  annotation (
