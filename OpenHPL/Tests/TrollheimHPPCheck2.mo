...
model TrollheimHPPCheck2
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=gen1.W_g)
  ...
  ElectroMech.Turbines.Turbine turbine2(
    ...
    ConstEfficiency=false) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=gen2.W_g)
  ...
  Modelica.Blocks.Sources.RealExpression realExpression2(y=turbine1.P_out)
    annotation (Placement(transformation(extent={{20,-62},{40,-42}})));
  Modelica.Blocks.Sources.RealExpression realExpression3(y=turbine2.P_out)
...
//  Line(points = {{-19, 4}, {-12.5, 4}, {-12.5, 4}, {-4, 4}}, color = {0, 0, 127}));
  ...
  connect(turbine1.P_out, gen1.P_in)
    annotation (Line(points={{34,9},{36,9},{36,-12}}, color={0,0,127}));
  connect(turbine2.P_out, gen2.P_in)
    annotation (Line(points={{2,-23},{2,-32},{0,-32}}, color={0,0,127}));
  connect(gen2.u, PID1.u_s) annotation (Line(points={{-10,-44},{-54,-44},{-54,
          -14},{-50,-14}}, color={0,0,127}));
  connect(gen1.u, PID.u_s) annotation (Line(points={{26,-24},{-22,-24},{-22,80},
          {-20,80}}, color={0,0,127}));
  annotation (
