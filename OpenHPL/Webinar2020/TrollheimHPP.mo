...
extends Modelica.Icons.Example;
  ...
  OpenHPL.Waterway.Pipe intake(D_i = 6, D_o = 6,H = 20, L = 4500)  annotation(
    Placement(visible = true, transformation(origin = {-40, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  OpenHPL.Waterway.SurgeTank surgeTank(D = 4, H = 80, L = 80, SteadyState = true, SurgeTankType = OpenHPL.Types.SurgeTank.STSimple, h_0 = 70)  annotation(
  ...
  Modelica.Blocks.Sources.Ramp valveSiganlTurbine(duration = 0, height = -0.99, offset = 1, startTime = 300)  annotation(
