...
package DataGeneratorTest
  "This is a simulation tests for finding analytical expression based on nominal values."
  ...
  model HydroCordModelTest "Model of Trollheim hydro power plant."
    ...
    OpenHPL.Waterway.Pipe discharge1(
      ...
      H=17.5 - 14,
      L=601,
      p_eps=0.05) annotation (Placement(visible=true, transformation(extent={{48, 26}, {68, 46}},                                                                         rotation=0)));
    OpenHPL.Waterway.Reservoir tail(
      
      H_r=24.5 - 22.6,Input_level= false,
    ...
    OpenHPL.Waterway.SurgeTank surgeTank(
      ...
      p_eps=0.05) annotation (Placement(visible=true, transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=0)));
    OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v = 6.6, ConstEfficiency=false, ValveCapacity = true) annotation (Placement(visible=true, transformation(
          origin={32,-6},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    ...
    Waterway.Fitting fitting(D_i=4.7, D_o=3.3) annotation (Placement(
          ...
          rotation=90,
          origin={16,28})));
    OpenHPL.Waterway.DraftTube draftTube(
      
      D_i=3.3,
      D_o= 3.5, DraftTubeType = OpenHPL.Types.DraftTube.ConicalDiffuser,H= 3,
      L= 3.2, theta = 0) annotation (Placement(visible = true, transformation(extent = {{48, -26}, {68, -6}}, rotation = 0)));
    OpenHPL.Waterway.Fitting fitting1(D_i=3.3, D_o=6.3)
      annotation (Placement(visible = true, transformation(extent = {{48, 0}, {68, 20}}, rotation = 0)));
  equation
    ...
    connect(reservoir.o, intake1.i) annotation(
      Line(points = {{-84, 64}, {-80, 64}, {-80, 66}, {-78, 66}}, color = {28, 108, 200}));
    connect(intake2.i, intake1.o) annotation(
      Line(points = {{-58, 62}, {-58, 66}}, color = {28, 108, 200}));
    connect(intake3.i, intake2.o) annotation(
      Line(points = {{-36, 54}, {-38, 54}, {-38, 62}}, color = {28, 108, 200}));
    connect(intake3.o, surgeTank.i) annotation(
      Line(points = {{-16, 54}, {-18, 54}, {-18, 70}}, color = {28, 108, 200}));
    connect(surgeTank.o, penstock1.i) annotation(
      Line(points = {{2, 70}, {6, 70}, {6, 64}, {10, 64}}, color = {28, 108, 200}));
    connect(turbine.i, penstock2.o) annotation(
      Line(points = {{22, -6}, {20, -6}, {20, -8}, {6, -8}}, color = {28, 108, 200}));
    connect(tail.o, discharge2.o) annotation(
      Line(points = {{88, 8}, {88, 56}, {84, 56}}, color = {28, 108, 200}));
    connect(penstock1.o, fitting.o) annotation(
      Line(points = {{10, 44}, {14, 44}, {14, 38}, {16, 38}}, color = {28, 108, 200}));
    connect(penstock2.i, fitting.i) annotation(
      Line(points = {{6, 12}, {18, 12}, {18, 18}, {16, 18}}, color = {28, 108, 200}));
    connect(turbine.o, draftTube.i) annotation(
      Line(points = {{42, -6}, {42, -11}, {48, -11}, {48, -16}}, color = {28, 108, 200}));
    connect(discharge2.i, discharge1.o) annotation(
      Line(points = {{64, 56}, {68, 56}, {68, 36}}, color = {28, 108, 200}));
    connect(draftTube.o, fitting1.i) annotation(
      Line(points = {{68, -16}, {68, -3}, {48, -3}, {48, 10}}, color = {28, 108, 200}));
    connect(discharge1.i, fitting1.o) annotation(
      Line(points = {{48, 36}, {48, 10}, {68, 10}}, color = {28, 108, 200}));
    annotation (
      experiment(StopTime = 3600, StartTime = 0, Tolerance = 0.0001, Interval = 1));
  end HydroCordModelTest;

  model HydroCordModelTest2 "Model of Trollheim hydro power plant."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r=418.5 - 372, UseInFlow=false) annotation (Placement(visible=true, transformation(
          origin={-94,64},
          extent={{-10,-10},{10,10}},
    ...
    OpenHPL.Waterway.Pipe discharge1(
      ...
      H=17.5 - 14,
      L=601,
      p_eps=0.05) annotation (Placement(visible=true, transformation(extent={{50,-14},
              {70,6}},                                                                          rotation=0)));
    OpenHPL.Waterway.Reservoir tail(
      Input_level=true,
      H_r=24.5 - 22.6,
  ...
  equation
    ...
    connect(intake3.i, intake2.o)
      annotation (Line(points={{-36,54},{-38,54},{-38,62}}, color={28,108,200}));
    connect(intake3.o, surgeTank.i)
      annotation (Line(points={{-16,54},{-18,54},{-18,70}}, color={28,108,200}));
    ...
    connect(discharge2.i, discharge1.o) annotation (Line(points={{64,56},{68,56},
            {68,-4},{70,-4}}, color={28,108,200}));
    connect(turbine.o, discharge1.i) annotation (Line(points={{42,-6},{46,-6},{
            46,-4},{50,-4}}, color={28,108,200}));
    annotation (
      experiment(StopTime = 3600, StartTime = 0, Tolerance = 0.0001, Interval = 1));
  end HydroCordModelTest2;
